...
<head>
    ...
    <title>Transaction History - Finance Management System</title>
    <link rel="stylesheet" href="<%= request.getContextPath() %>/history.css">
</head>
<body>
    <%
    ...
    <div class="history-container">
        ...
        <div id="summary-stats">
            <div class="stat-card">
                ...
                <p class="stat-value" id="total-savings">$0</p>
            </div>
            <div class="stat-card">
            ...
            <div class="stat-card">
                ...
                <p class="stat-value" id="total-debits">$0</p>
            </div>
        </div>
    ...
    <div class="nav-bar">
        ...
        <a href="<%= request.getContextPath() %>/history.jsp" class="nav-item active">
            <div class="nav-icon">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <script src="<%= request.getContextPath() %>/history.js"></script>
</body>
</html>