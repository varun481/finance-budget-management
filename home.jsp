...
<body>
    ...
    <div id="credit-modal" class="modal">
        <div class="modal-content">
            <span class="close-button">×</span>
            <h2 id="credit-modal-title">Add Credit</h2>
            <div class="modal-input">
                <label for="credit-amount">Amount ($):</label>
                <input type="number" id="credit-amount" placeholder="Enter amount" min="0" step="0.01">
            </div>
            <div class="modal-input">
                <label for="credit-purpose">Purpose:</label>
                <textarea id="credit-purpose" placeholder="Enter purpose" rows="3"></textarea>
            </div>
            <button id="submit-credit" class="modal-button credit-button">Submit</button>
        </div>
    </div>

    <div id="debit-modal" class="modal">
        <div class="modal-content">
            <span class="close-button">×</span>
            <h2 id="debit-modal-title">Add Debit</h2>
            <div class="modal-input">
                <label for="debit-amount">Amount ($):</label>
                <input type="number" id="debit-amount" placeholder="Enter amount" min="0" step="0.01">
            </div>
            <div class="modal-input">
                <label for="debit-purpose">Purpose:</label>
                <textarea id="debit-purpose" placeholder="Enter purpose" rows="3"></textarea>
            </div>
            <button id="submit-debit" class="modal-button debit-button">Submit</button>
        </div>
    </div>

    <div class="chart-container">
        <div class="donut-chart">
            <canvas id="savings-chart" width="200" height="200"></canvas>
            <div class="chart-label">
                <p>Savings amount</p>
                <h2 id="savings-amount">$0</h2>
            </div>
        </div>
    </div>
    ...
    <div class="cards-container">
        <div class="card">
            <p class="card-title">Total Purchases</p>
            <p class="card-value" id="total-purchases">$0</p>
        </div>
        <div class="card">
            <p class="card-title">Total Income</p>
            <p class="card-value" id="total-income">$0</p>
        </div>
        <div class="card full-width-card">
            <p class="card-title">Remaining Balance</p>
            <p class="card-value" id="remaining-balance">$0</p>
        </div>
    </div>

    <div class="transaction-container">
        <div class="transaction-box credit-box">
            <h2 class="transaction-title">Recent Credits</h2>
            <ul id="credit-list" class="transaction-list"></ul>
            <button id="credit-button" class="transaction-button credit-button">Add Credit</button>
        </div>
        <div class="transaction-box debit-box">
            <h2 class="transaction-title">Recent Debits</h2>
            <ul id="debit-list" class="transaction-list"></ul>
            <button id="debit-button" class="transaction-button debit-button">Add Debit</button>
        </div>
    </div>
