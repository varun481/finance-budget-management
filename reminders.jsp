...
<head>
    ...
    <title>Reminders - Finance Management System</title>
    <link rel="stylesheet" href="<%= request.getContextPath() %>/reminders.css">
</head>
<body style="visibility: hidden;">
    ...
    <div class="reminder-container">
        <div class="reminder-box">
            <h2 class="reminder-title">Add New Reminder</h2>
            <div class="reminder-form">
                <div class="form-input">
                    <label for="reminderTitle">Title</label>
                    <input type="text" id="reminderTitle" placeholder="e.g., Pay Electricity Bill" required>
                </div>
                <div class="form-input">
                    <label for="reminderAmount">Amount ($)</label>
                    <input type="number" id="reminderAmount" placeholder="e.g., 100.00" step="0.01" required>
                </div>
                <div class="form-input">
                    <label for="reminderDueDate">Due Date</label>
                    <input type="date" id="reminderDueDate" required>
                </div>
                <button class="reminder-button" onclick="addReminder()">Add Reminder</button>
            </div>
        </div>
        <div class="reminder-box">
            <h2 class="reminder-title">Upcoming Reminders</h2>
            <ul id="reminder-list" class="reminder-list"></ul>
        </div>
    </div>

    <div class="completed-reminders-container">
        <h2 class="reminder-title">Completed Reminders</h2>
        <ul id="completed-reminder-list" class="reminder-list"></ul>
    </div>
    ...
    <div class="nav-bar">
        ...
        <a href="<%= request.getContextPath() %>/reminders.jsp" class="nav-item active">
            <div class="nav-icon">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <script src="<%= request.getContextPath() %>/reminders.js"></script>
</body>
</html>